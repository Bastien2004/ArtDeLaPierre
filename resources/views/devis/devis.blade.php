...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/devisTableau.css') }}?v={{ filemtime(public_path('css/devisTableau.css')) }}">
                ...
                <td colspan="9">
                    <div class="group-content">
                        <div class="group-left">
                            ...
                            <span class="group-date">{{"REF : " . $p->reference }}</span>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('#tableDevis').DataTable({
            ...
            stateSave:  true,
            stateDuration: 60 * 60 * 2, // Garde la recherche en memoire pendant 2 h
        });
