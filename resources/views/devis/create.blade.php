            ...
            <div class="ligne-pierre" data-index="0">
                ...
                <div class="form-grid" style="grid-template-columns: 1.5fr 1fr 1fr 1fr 1fr 1fr;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.001" name="lignes[0][poids]" class="input-poids" readonly style="background: #f1f1f1; font-weight: bold;">
                    </div>
    ...
    function addCalculatedSpec(button, nom, prixUnitaire, unite) {
        ...
        const tailleField = nom.toLowerCase().includes('rejingot') ? `
            <div class="taille-rejingot-wrapper">
                <input type="number" name="lignes[${pIdx}][specs][${sIdx}][tailleMin]" value="2" min="0" step="0.001">
                <span class="separator">/</span>
                <input type="number" name="lignes[${pIdx}][specs][${sIdx}][tailleMax]" value="3" min="0" step="0.001">
        ...
        const specHtml = `
            <div class="ligne-spec">
                <div class="form-grid-specs" style="display: flex; gap: 10px; margin-bottom: 5px; align-items: center;">
                    ...
                    <input type="number" step="0.001" name="lignes[${pIdx}][specs][${sIdx}][prix]" value="${prixFinal.toFixed(2)}" class="form-control spec-prix-input" data-unite="${unite}" data-base-price="${prixUnitaire}">
